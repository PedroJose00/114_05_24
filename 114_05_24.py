...
with XDMFFile(mesh.comm, "./14_05_24/fem_function_BVTV.xdmf", "w") as file:
...
# ----------------------------------------------------------------------------------
with XDMFFile(mesh.comm, "./14_05_24/fem_function_modulo_E_0.xdmf", "w") as file:
          file.write_mesh(mesh)
          file.write_function(fem_function_modulo_E_f ,0.0)


with XDMFFile(mesh.comm, "./14_05_24/fem_function_densidad_0.xdmf", "w") as file:
          file.write_mesh(mesh)
...
for dmes in range(1, 2):
    ...
    for dday in range(1, 25):  # Ciclo externo con dtime va de 1 a 24
        ...
        for cycle in range(1000, 10001, 1000):  # Ciclo interno va de 1000 en 1000 hasta 10000
            ...
            # with XDMFFile(mesh.comm, "./14_05_24/fase_1/fem_function_array_rdot.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_array_rdot , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./14_05_24/fase_1/fem_function_array_psi.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_array_psi , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./14_05_24/fase_1/fem_function_array_error.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_array_error , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./14_05_24/fase_1/fem_function_array_alpha.xdmf", "w") as file:
            #     file.write_mesh(mesh)
    ...
    with XDMFFile(mesh.comm, "./14_05_24/fase_1/fem_function_densidad_fase_1.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_densidad_gr_cm3 , tmp_day)
    with XDMFFile(mesh.comm, "./14_05_24/fase_1/fem_function_BVTV_fase_1.xdmf", "w") as file:
        file.write_mesh(mesh)
...
#---------------------------------------------------------------------------------------------------
    ...
    for dday in range(1, 8):  # Ciclo externo con dtime va de 1 a 8
        ...
        for cycle in range(1000, 10001, 1000):  # Ciclo interno va de 1000 en 1000 hasta 10000
            ...
            # # ----------------------------------------------------------------------------------------------------------
            # with XDMFFile(mesh.comm, "./14_05_24/fase_2/fem_function_array_modulo.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_modulo_E_f , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./14_05_24/fase_2/fem_function_array_damage.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_damage , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./14_05_24/fase_2/fem_function_array_rdot.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_array_rdot , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./14_05_24/fase_2/fem_function_array_psi.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_array_psi , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./14_05_24/fase_2/fem_function_array_error.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_array_error , tmp_cycle)    
    ...
    with XDMFFile(mesh.comm, "./14_05_24/fase_2/fem_function_densidad.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_densidad_gr_cm3 , tmp_day)
    with XDMFFile(mesh.comm, "./14_05_24/fase_2/fem_function_BVTV.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_BVTV , tmp_day)
...
#----------------------------------------------------------------------------------------------
    for dday in range(1, 64):  # Ciclo externo con dtime va de 1 a 64
        ...
        for cycle in range(1000, 10001, 1000):  # Ciclo interno va de 1000 en 1000 hasta 10000
            ...
            array_formacion_vb[condicion_trabecular]= array_formacion_vb[condicion_trabecular] + array_derivative_NBMU[condicion_trabecular]
            ...
            # ----------------------------------------------------------------------------------------------------------
            with XDMFFile(mesh.comm, "./14_05_24/fase_3/fem_function_array_modulo.xdmf", "w") as file:
                file.write_mesh(mesh)
                file.write_function(fem_function_modulo_E_f , tmp_cycle)    
            
            with XDMFFile(mesh.comm, "./14_05_24/fase_3/fem_function_array_damage.xdmf", "w") as file:
                file.write_mesh(mesh)
                file.write_function(fem_function_damage , tmp_cycle)    
            with XDMFFile(mesh.comm, "./14_05_24/fase_2/fem_function_alpha.xdmf", "w") as file:
                  file.write_mesh(mesh)
                  file.write_function(fem_function_alpha , tmp_cycle)    
            with XDMFFile(mesh.comm, "./14_05_24/fase_3/fem_function_array_rdot.xdmf", "w") as file:
                file.write_mesh(mesh)
                file.write_function(fem_function_array_rdot , tmp_cycle)    
            with XDMFFile(mesh.comm, "./14_05_24/fase_3/fem_function_array_psi.xdmf", "w") as file:
                file.write_mesh(mesh)
                file.write_function(fem_function_array_psi , tmp_cycle)    
            with XDMFFile(mesh.comm, "./14_05_24/fase_3/fem_function_array_error.xdmf", "w") as file:
                file.write_mesh(mesh)
                file.write_function(fem_function_array_error , tmp_cycle)    
    ...
    with XDMFFile(mesh.comm, "./14_05_24/fase_3/fem_function_densidad_fase_3.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_densidad_gr_cm3 , tmp_day)
    with XDMFFile(mesh.comm, "./14_05_24/fase_3/fem_function_BVTV_fase_3.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_BVTV , tmp_day)
...
#----------------------------------------------------------------------------------------------
    for dday in range(1, 5):  # Ciclo externo con dtime va de 1 a 5
        ...
        for cycle in range(1000, 10001, 1000):  # Ciclo interno va de 1000 en 1000 hasta 10000
            ...
            # # ----------------------------------------------------------------------------------------------------------
            # with XDMFFile(mesh.comm, "./14_05_24/fase_4/fem_function_modulo.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_modulo_E_f , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./14_05_24/fase_4/fem_function_densidad_material.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_densidad_material , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./14_05_24/fase_4/fem_function_BVTV.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_BVTV , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./14_05_24/fase_4/fem_function_array_modulo.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_modulo_E_f , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./14_05_24/fase_4/fem_function_array_vm.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_array_vm , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./14_05_24/fase_4/fem_function_array_damage.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_damage , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./14_05_24/fase_4/fem_function_alpha.xdmf", "w") as file:
            #      file.write_mesh(mesh)
            #      file.write_function(fem_function_alpha , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./14_05_24/fase_4/fem_function_array_rdot.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_array_rdot , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./14_05_24/fase_4/fem_function_array_psi.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_array_psi , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./14_05_24/fase_4/fem_function_array_error.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_array_error , tmp_cycle)    
    ...
    with XDMFFile(mesh.comm, "./14_05_24/fase_4/fem_function_array_error.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_array_error , tmp_cycle)    
    with XDMFFile(mesh.comm, "./14_05_24/fase_4/fem_function_densidad_fase_4.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_densidad_gr_cm3 , tmp_day)
    with XDMFFile(mesh.comm, "./14_05_24/fase_4/fem_function_BVTV_fase_4.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_BVTV , tmp_day)
...
#            array_modulo_E_f[condicion_cortical]= 84370 * (array_BVTV[condicion_cortical] ** 2.58) * (array_alpha ** 2.74) *1e3
            ...
            # # ----------------------------------------------------------------------------------------------------------
            # with XDMFFile(mesh.comm, "./14_05_24/fase_5/fem_function_modulo.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_modulo_E_f , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./14_05_24/fase_5/fem_function_densidad_material.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_densidad_material , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./14_05_24/fase_5/fem_function_array_damage.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_damage , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./14_05_24/fase_5/fem_function_array_alpha.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_alpha , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./14_05_24/fase_5/fem_function_array_rdot.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_array_rdot , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./14_05_24/fase_5/fem_function_array_psi.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_array_psi , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./14_05_24/fase_5/fem_function_array_error.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_array_error , tmp_cycle)    
    ...
    with XDMFFile(mesh.comm, "./14_05_24/fase_5/fem_function_densidad_material.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_densidad_material , tmp_cycle)    
    with XDMFFile(mesh.comm, "./14_05_24/fase_5/fem_function_BVTV.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_BVTV , tmp_cycle)    
    with XDMFFile(mesh.comm, "./14_05_24/fase_5/fem_function_array_modulo.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_modulo_E_f , tmp_cycle)    
    with XDMFFile(mesh.comm, "./14_05_24/fase_5/fem_function_array_vm.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_array_vm , tmp_cycle)    
    with XDMFFile(mesh.comm, "./14_05_24/fase_5/fem_function_array_damage.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_damage , tmp_cycle)    
    with XDMFFile(mesh.comm, "./14_05_24/fase_5/fem_function_alpha.xdmf", "w") as file:
         file.write_mesh(mesh)
         file.write_function(fem_function_alpha , tmp_cycle)    
    with XDMFFile(mesh.comm, "./14_05_24/fase_5/fem_function_array_rdot.xdmf", "w") as file:
        file.write_mesh(mesh)
    ...
    with XDMFFile(mesh.comm, "./14_05_24/fase_5/fem_function_array_error.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_array_error , tmp_cycle)    
    with XDMFFile(mesh.comm, "./14_05_24/fase_5/fem_function_densidad_fase_4.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_densidad_gr_cm3 , tmp_day)
    with XDMFFile(mesh.comm, "./14_05_24/fase_5/fem_function_BVTV_fase_4.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_BVTV , tmp_day)
        
    with XDMFFile(mesh.comm, "./14_05_24/fase_5/fem_function_densidad_fase_5.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_densidad_gr_cm3 , tmp_day)
    with XDMFFile(mesh.comm, "./14_05_24/fase_5/fem_function_BVTV_fase_5.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_BVTV , tmp_day)
    print("---------------------------------------------------------")              
    print("El valor promedio de la BVTV es:", promedios_BVTV[escalar_contador_total_dias])
...
#            array_modulo_E_f[condicion_cortical]= 84370 * (array_BVTV[condicion_cortical] ** 2.58) * (array_alpha ** 2.74) *1e3
    ...
    with XDMFFile(mesh.comm, "./14_05_24/fase_52/fem_function_modulo.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_modulo_E_f , tmp_cycle)    
    with XDMFFile(mesh.comm, "./14_05_24/fase_52/fem_function_densidad_material.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_densidad_material , tmp_cycle)    
    with XDMFFile(mesh.comm, "./14_05_24/fase_52/fem_function_BVTV.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_BVTV , tmp_cycle)    
    with XDMFFile(mesh.comm, "./14_05_24/fase_52/fem_function_array_modulo.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_modulo_E_f , tmp_cycle)    
    with XDMFFile(mesh.comm, "./14_05_24/fase_52/fem_function_array_vm.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_array_vm , tmp_cycle)    
    with XDMFFile(mesh.comm, "./14_05_24/fase_52/fem_function_array_damage.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_damage , tmp_cycle)    
    with XDMFFile(mesh.comm, "./14_05_24/fase_52/fem_function_alpha.xdmf", "w") as file:
         file.write_mesh(mesh)
         file.write_function(fem_function_alpha , tmp_cycle)    
    with XDMFFile(mesh.comm, "./14_05_24/fase_52/fem_function_array_rdot.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_array_rdot , tmp_cycle)    
    with XDMFFile(mesh.comm, "./14_05_24/fase_52/fem_function_array_psi.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_array_psi , tmp_cycle)    
    with XDMFFile(mesh.comm, "./14_05_24/fase_52/fem_function_array_error.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_array_error , tmp_cycle)    
    with XDMFFile(mesh.comm, "./14_05_24/fase_52/fem_function_densidad_fase_52.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_densidad_gr_cm3 , tmp_day)
    with XDMFFile(mesh.comm, "./14_05_24/fase_52/fem_function_BVTV_fase_52.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_BVTV , tmp_day)
...
#            array_modulo_E_f[condicion_cortical]= 84370 * (array_BVTV[condicion_cortical] ** 2.58) * (array_alpha ** 2.74) *1e3
            ...
            # ----------------------------------------------------------------------------------------------------------
            # with XDMFFile(mesh.comm, "./14_05_24/fase_6/fem_function_array_modulo.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_modulo_E_f , tmp_cycle)    
            
            # with XDMFFile(mesh.comm, "./14_05_24/fase_6/fem_function_array_damage.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_damage , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./14_05_24/fase_2/fem_function_alpha.xdmf", "w") as file:
            #      file.write_mesh(mesh)
            #      file.write_function(fem_function_alpha , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./14_05_24/fase_6/fem_function_array_rdot.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_array_rdot , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./14_05_24/fase_6/fem_function_array_psi.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_array_psi , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./14_05_24/fase_6/fem_function_array_error.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_array_error , tmp_cycle)    
           ...
           # print("Sigma_bar:", sigma_bar_i)
            ...
            print("#-------------------------------------------------------------------------------------------------")
    with XDMFFile(mesh.comm, "./14_05_24/fase_6/fem_function_modulo.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_modulo_E_f , tmp_cycle)    
    with XDMFFile(mesh.comm, "./14_05_24/fase_6/fem_function_densidad_material.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_densidad_material , tmp_cycle)    
    with XDMFFile(mesh.comm, "./14_05_24/fase_6/fem_function_BVTV.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_BVTV , tmp_cycle)    
    with XDMFFile(mesh.comm, "./14_05_24/fase_6/fem_function_array_modulo.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_modulo_E_f , tmp_cycle)    
    with XDMFFile(mesh.comm, "./14_05_24/fase_6/fem_function_array_vm.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_array_vm , tmp_cycle)    
    with XDMFFile(mesh.comm, "./14_05_24/fase_6/fem_function_array_damage.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_damage , tmp_cycle)    
    with XDMFFile(mesh.comm, "./14_05_24/fase_6/fem_function_alpha.xdmf", "w") as file:
         file.write_mesh(mesh)
         file.write_function(fem_function_alpha , tmp_cycle)    
    with XDMFFile(mesh.comm, "./14_05_24/fase_6/fem_function_array_rdot.xdmf", "w") as file:
        file.write_mesh(mesh)
    ...
    with XDMFFile(mesh.comm, "./14_05_24/fase_6/fem_function_array_error.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_array_error , tmp_cycle)    
    with XDMFFile(mesh.comm, "./14_05_24/fase_6/fem_function_densidad_fase_6.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_densidad_gr_cm3 , tmp_day)
    with XDMFFile(mesh.comm, "./14_05_24/fase_6/fem_function_BVTV_fase_6.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_BVTV , tmp_day)
#-------------------------------------------------------------------------------------------
...
#-------------------------------------------------------------------------------------------
    ...
    for dday in range(1, 65):  # Ciclo externo con dtime va de 1 a 96
        ...
        for cycle in range(1000, 10001, 1000):  # Ciclo interno va de 1000 en 1000 hasta 10000
            ...
            expression_array_dot_vb =  (1 - array_porosidad) * array_derivative_NBMU *escalar_V_bmu * escalar_tmp_af7 * t_prima_100_TR_TI_TF
...
#            array_modulo_E_f[condicion_cortical]= 84370 * (array_BVTV[condicion_cortical] ** 2.58) * (array_alpha ** 2.74) *1e3
            ...
            # ----------------------------------------------------------------------------------------------------------
            # with XDMFFile(mesh.comm, "./14_05_24/fase_7/fem_function_array_modulo.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_modulo_E_f , tmp_cycle)    
            
            # with XDMFFile(mesh.comm, "./14_05_24/fase_7/fem_function_array_damage.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_damage , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./14_05_24/fase_2/fem_function_alpha.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_alpha , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./14_05_24/fase_7/fem_function_array_rdot.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_array_rdot , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./14_05_24/fase_7/fem_function_array_psi.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_array_psi , tmp_cycle)    
            # with XDMFFile(mesh.comm, "./14_05_24/fase_7/fem_function_array_error.xdmf", "w") as file:
            #     file.write_mesh(mesh)
            #     file.write_function(fem_function_array_error , tmp_cycle)    
    ...
    with XDMFFile(mesh.comm, "./14_05_24/fase_7/misses_.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(sigma_vm_h , dday)
    with XDMFFile(mesh.comm, "./14_05_24/fase_7/displacements_.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(uh_in, dday)
    with XDMFFile(mesh.comm, "./14_05_24/fase_7/sigma_.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(value_sigma_h , dday)
    with XDMFFile(mesh.comm, "./14_05_24/fase_7/fem_function_modulo.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_modulo_E_f , tmp_cycle)    
    with XDMFFile(mesh.comm, "./14_05_24/fase_7/fem_function_densidad_material.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_densidad_material , tmp_cycle)    
    with XDMFFile(mesh.comm, "./14_05_24/fase_7/fem_function_BVTV.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_BVTV , tmp_cycle)    
    with XDMFFile(mesh.comm, "./14_05_24/fase_7/fem_function_array_modulo.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_modulo_E_f , tmp_cycle)    
    with XDMFFile(mesh.comm, "./14_05_24/fase_7/fem_function_array_vm.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_array_vm , tmp_cycle)    
    with XDMFFile(mesh.comm, "./14_05_24/fase_7/fem_function_array_damage.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_damage , tmp_cycle)    
    with XDMFFile(mesh.comm, "./14_05_24/fase_7/fem_function_alpha.xdmf", "w") as file:
         file.write_mesh(mesh)
         file.write_function(fem_function_alpha , tmp_cycle)    
    with XDMFFile(mesh.comm, "./14_05_24/fase_7/fem_function_array_rdot.xdmf", "w") as file:
        file.write_mesh(mesh)
    ...
    with XDMFFile(mesh.comm, "./14_05_24/fase_7/fem_function_array_error.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_array_error , tmp_cycle)    
    with XDMFFile(mesh.comm, "./14_05_24/fase_7/fem_function_densidad_fase_7.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_densidad_gr_cm3 , tmp_day)
    with XDMFFile(mesh.comm, "./14_05_24/fase_7/fem_function_BVTV_fase_7.xdmf", "w") as file:
        file.write_mesh(mesh)
        file.write_function(fem_function_BVTV , tmp_day)
...
data.to_csv('./14_05_24/resultados_promedio_final.csv', index=False)
